...
exports.ingresarUsuario = async (req, res) => {
    try
    {
        ...
        const token = jst.sign({ id: usuario.id, email: usuario.email }, 'secretKey',{ expiresIn: '1' }); // 'secretKey' debe ser una clave secreta segura y no debe ser expuesta en el código fuente
...
exports.registrarUsuario = async (req, res) => {
    try {
        ...
        let password = bcrypt.hashSync(req.body.password, 10); // encripta la contraseña
